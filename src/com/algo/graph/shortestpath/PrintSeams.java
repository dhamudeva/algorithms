    ...
    public static void main(String[] args) {
      Picture picture = new Picture("/Users/dhamod/Application data/Git Repo/"
        ...
        StdOut.printf("%s (%d-by-%d image)\n", 
            "/Users/dhamod/Application data/Git Repo/"
                + "algorithms/seamcarving/seamCarving/7x10.png", 
                picture.width(), picture.height());
        StdOut.println();
        StdOut.println("The table gives the dual-gradient energies of each pixel.");
        StdOut.println("The asterisks denote a "
            + "minimum energy vertical or horizontal seam.");
        StdOut.println();
        ...
        int[] verticalSeam = {2, 3, 4, 3, 4, 3, 3, 2, 2, 1}; 
